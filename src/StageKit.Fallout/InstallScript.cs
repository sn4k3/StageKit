...
internal static class InstallScript
{
        ...
        IReadOnlyCollection<ApplicationPackagingType> selectedPackagingTypes)
    {
        ...
        ArgumentException.ThrowIfNullOrWhiteSpace(macOsMinimumVersion);
        ...
        return Template
            ...
            .Replace("{{MACOS_MINIMUM_VERSION}}", EscapeSingleQuoted(macOsMinimumVersion), StringComparison.Ordinal)
