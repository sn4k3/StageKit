...
/// <summary>
/// Creates the Windows PowerShell uninstallation script emitted by
/// <see cref="StageKitBuild.GenerateInstallScript"/>.
/// </summary>
internal static class WindowsUninstallScript
{
    internal static string Create(string applicationName, string wingetPackageId)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(applicationName);
        ArgumentNullException.ThrowIfNull(wingetPackageId);

        applicationName = FileUtilities.ValidatePathLeafName(applicationName, nameof(applicationName));
        wingetPackageId = wingetPackageId.Trim();
        ...
        return Template
            ...
            .Replace("{{APPLICATION_SLUG}}", EscapeSingleQuoted(LinuxPackage.GetPackageName(applicationName)),
