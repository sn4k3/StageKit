...
public partial class UpdatumManager : DisposableObject, INotifyPropertyChanged
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var script = new ShellScriptFile();
        ...
        // ** Windows **
        // *************
        void WriteWindowsScriptHeader(TextWriter stream)
        {
        ...
        void WriteWindowsScriptFileValidation(TextWriter stream)
        {
        ...
        void WriteWindowsScriptKillInstances(TextWriter stream)
        {
        ...
        void WriteWindowsScriptInjectCustomScript(TextWriter stream)
        {
        ...
        void WriteWindowsScriptEnd(TextWriter stream)
        {
        ...
        // ** Linux **
        // ***********
        void WriteLinuxScriptHeader(TextWriter stream)
        {
            stream.WriteLine(
        ...
        void WriteLinuxScriptKillInstances(TextWriter stream)
        {
        ...
        void WriteLinuxScriptInjectCustomScript(TextWriter stream)
        {
            if (!string.IsNullOrWhiteSpace(InstallUpdateInjectCustomScript))
            {
        ...
        void WriteLinuxScriptEnd(TextWriter stream)
        {
            stream.WriteLine("echo \"- Removing temp source files\"");
        ...
        return Task.Run(async () =>
        {
            ...
            try
            {
                ...
                if (inferredPackageType is ApplicationPackagingType.MacOSPkg or ApplicationPackagingType.MacOSDmg)
                {
                    ...
                    using var stream = ShellScriptFile.CreateTemporary(installWorkspacePath);
                    var installScriptFilePath = stream.FilePath;
                    WriteLinuxScriptHeader(stream);
                    stream.WriteLine(
