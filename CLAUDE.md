...
- **csharp-lsp plugin** — wires `csharp-ls` in as Claude Code's native C#/.cs language server (go-to-definition, references, diagnostics) without needing Rider or Serena.
